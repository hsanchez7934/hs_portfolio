	...
	return (
		<main className="min-h-screen bg-white text-gray-900 font-sans pt-20">
			...
			>
				...
				>
					Front End Software Developer and React Native Software Developer
				</p>
				<button
			...
			>
				<div className="max-w-4xl mx-auto mb-12">
					...
					<p className={`${textSizesSecondary}`} id="user-summary">
			...
			<section className="py-20 px-6 bg-gray-100 dark:bg-gray-950" id="projects-section">
				<div className="max-w-4xl mx-auto mb-12">
					...
					<div>
						<p className={`mb-5 ${textSizesSecondary}`}>
							<a
						...
						<p className={`mb-10 ${textSizesSecondary}`}>
